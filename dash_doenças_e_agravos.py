...
# Função utilitária para criar/recriar a figura do mapa com a API moderna
        ...
        html.Div(id="conteudo-principal", style={"padding": "24px 32px"}, children=[
            ...
            html.Div(style={"marginTop": 24}, children=[
                _card([
                    ...
                    html.Div([
                        html.Div([
                            ...
                            dcc.Dropdown(
                                ...
                                value=[], multi=True, placeholder="Todas as doenças",
                        ...
                        html.Div([
                            ...
                            dcc.Input(
                                id="mapa-busca-municipio", type="text",
                                placeholder="Digite o nome...", debounce=True,
                    ...
                    dcc.Graph(id="mapa-municipios", figure=fig_mapa,
                ...
                _card([
                    ...
                    html.Div([
                        ...
                        html.Div([
                            ...
                            dcc.Dropdown(
                                id="filtro-regiao",
                                options=[{"label": "Todas", "value": "Todos"}] + [{"label": r, "value": r} for r in regioes],
                        ...
                        html.Div([
                            ...
                            dcc.Dropdown(
                                id="filtro-uf",
                                options=[{"label": "Todas", "value": "Todos"}] + [{"label": uf, "value": uf} for uf in ufs],
                                value="Todos", clearable=False,
                        ...
                        html.Div([
                            ...
                            dcc.Dropdown(
                                id="filtro-ano",
                                options=[{"label": "Todos", "value": "Todos"}] + [{"label": a, "value": a} for a in anos],
                                value="Todos", clearable=False,
                                style={"width": "120px", "fontSize": 13},
                            ),
                        ]),
                        html.Div([
                            ...
                            dcc.Dropdown(
                                id="filtro-mes",
                                options=[{"label": "Todos", "value": "Todos"}] + [{"label": NOME_MES[m], "value": m} for m in meses],
                                value="Todos", clearable=False,
...
# ── Callback: Atualizar Mapa (Sem Patch(), com retorno do Figure completo) ────
@app.callback(
...
def grafico_clique_municipio(click_data, doencas_sel, ano_inicio, ano_fim):
    ...
    fig_evo.update_layout(
        ...
        plot_bgcolor="#ffffff", paper_bgcolor="#ffffff",
        font=dict(family="Inter, sans-serif", size=12, color="#333"),
        xaxis=dict(showgrid=True, gridcolor="#f0f0f0", title="Ano"),
        yaxis=dict(showgrid=True, gridcolor="#f0f0f0", title="Casos"),
        height=320,
    )

    return _card([
        _titulo(f"Evolução Anual de Casos — {nome_m} ({uf_m})"),
